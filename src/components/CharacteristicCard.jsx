...
export default function CharacteristicCard({ characteristic, count, isSelected, onClick }) {
  ...
  return (
    ...
    >
      <div className="text-4xl mb-2">{characteristic.icon}</div>
      <div className="font-medium">{characteristic.label}</div>
